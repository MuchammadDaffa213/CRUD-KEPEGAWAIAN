                    ...
                    <div class="card-body">
                        <form action="" method="post">
                            ...
                            <div class="mb-1">
                                ...
                                <input type="text" name="tb_notelpon" value="<?= @$var_notelpon ?>"
                                    class="form-control">
                            </div>
                    ...
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <div class="col-md-6">
                            <form action="index.php" method="GET" class="d-flex">
                                <input class="form-control me-2" type="search" placeholder="Cari pegawai"
                    ...
                    <div class="card-body overflow-x-auto">
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                $whereClause = '';
                                if (!empty($search)) {
                                    $whereClause = " WHERE nama LIKE '%$search%' OR alamat LIKE '%$search%' OR no_telpon LIKE '%$search%' OR nama_jabatan LIKE '%$search%'";
                                }
                                $result = mysqli_query($conn, "SELECT * FROM pegawai
                                INNER JOIN jabatan ON pegawai.id_jabatan = jabatan.id_jabatan
                                INNER JOIN kontrak ON pegawai.id_kontrak = kontrak.id_kontrak" . $whereClause);
